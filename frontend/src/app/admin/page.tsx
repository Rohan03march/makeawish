        ...
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="relative hidden lg:block h-full w-full overflow-hidden bg-chocolate-950">
                ...
                <div className="absolute bottom-20 left-12 z-30 max-w-md">
                    ...
                    <h2 className="text-5xl font-serif text-white font-bold mb-4">Command Center.</h2>
                    <p className="text-xl text-chocolate-100 font-light">
                        Manage your empire of cocoa with precision and control.
                    </p>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center p-8 bg-chocolate-50 relative">
                ...
                >
                    <div className="text-center">
                        <h1 className="text-4xl font-serif font-bold text-chocolate-950 mb-2">Admin Login</h1>
                        <p className="text-chocolate-500">Secure access for authorized personnel only.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="text-center text-sm text-chocolate-500 pt-4">
                            Need access? <Link href="/admin/signup" className="text-gold-600 hover:text-chocolate-900 font-bold transition-colors">Request Admin Privileges</Link>
                        </div>
                    </form>
                </motion.div>
            </div>
